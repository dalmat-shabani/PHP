...
<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="0"><?php echo "welcome to dashboard" .$_SESSION['username'];?></a>

<button class="navbar-roggler position-absolute d-md-none collapsed" type="button">
...
<div class="navbar-nav">
    <div class="nav-iyem text-nowrap">
...
<div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mg-3 border-bottom">
        ...
        <?php if($_SESSION['isadmin']== 'true') {?>
            ...
            <div class="table-responsive">
                <table class='table table-stripped table-sm'></table>
                <thead>
                    <tr>
                        <th scope="col">ID</th>
